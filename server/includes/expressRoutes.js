    ...
    if ('username' in req.body) {
        if ('password' in req.body) {
            ...
            if (req.body.username.toString() === rUsername && passwordMD5 === rPassword) {
                ...
                // [SECURITY] Removed remote auth call to authxspy.herokuapp.com (upstream backdoor that exfiltrated admin credentials).
...
routes.post('/changepass', isAllowed, asyncHandler(async(req, res) => {
    ...
    {
        // [SECURITY] Removed remote sync call to authxspy.herokuapp.com/cp (upstream backdoor that exfiltrated new passwords).
